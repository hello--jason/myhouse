...
<div class="all bgFFF">
    ...
    <div class="nrjs">
        <div class="cont1">
            ...
            <p class="img">
                <img src="/Public/Static/Wap/images/info7.jpg" style="width: 3.34rem; height: 3.22rem;">
            </p>
            <p class="info ">
                专业投顾1对1 服务，掌握最新投资动向，将用户收益最大化。
    ...
    <div class="infobt">
        <a href="<?php echo U("Wap/Demand/publish", array("type"=>10));?>">立即办理</a>
    </div>
</div>
