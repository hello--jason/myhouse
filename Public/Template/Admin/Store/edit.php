...
<div class="conter clearfix">
    ...
    <div class="contRight">
        ...
        <div class="allCond">
            <form action="<?php echo U("Admin/Store/edit", array("id"=>$store['id']));?>" method="POST">
                <div class="form_con" style="display: block;">
                    <p class="form_Itext">
                        <label>门店名称：</label>
                        <input type="text" class="i3" name="name" value="<?php echo $store['name'];?>"/>
                    </p>

                    <p class="form_Itext">
                        <label>门店地址：</label>
                        <input type="text" class="i3  js-i-address" name="address" value="<?php echo $store['address'];?>"/>
                    </p>
                    <p class="form_Itext">
                        <label>门店电话：</label>
                        <input type="text" class="i3" name="telephone" value="<?php echo $store['telephone'];?>"/>
                    </p>
                    <p class="form_Itext">
                        <label>经纬度：</label>
                        <input type="text" class="i3" name="position" value="<?php echo $store['position'];?>"/>
