...
<div class="conter clearfix">
    ...
    <div class="contRight">
        ...
        <div class="allCond">
            <form action="<?php echo U("Admin/Article/edit", array("id" => $article['id'])); ?>" method="POST">
                <div class="form_con" style="display: block;">
                    <p class="form_Itext">
                        <label>文章标题：</label>
                        <input type="text" class="i3" name="title" value="<?php echo $article['title']; ?>"/>
                    </p>
                    <div class="form_textarea clearfix">
                        <label>内容：</label>
                        <div class="textCon"><script id="container" name="content" type="text/plain" style="width:700px;height:400px;"><?php echo $article['content']; ?></script></div>
                    </div>
                    <p class="form_Itext">
                        <label>位置：</label>
                    ...
                    <div class="form_Itext clearfix form_check">
                        ...
                        <p class="checks">
                            <label class="check">
                                <input type="radio" name="display" value="1" <?php echo $article['display'] == 1 ? "checked='checked'": "";?> /> 开启
                            </label>
                            <label class="check">
                                <input type="radio" name="display" value="0" <?php echo $article['display'] == 0 ? "checked='checked'": "";?>/> 关闭
                            </label>
                            </label>
                        </p>
                    </div>
