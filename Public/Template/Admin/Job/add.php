...
<div class="conter clearfix">
    ...
    <div class="contRight">
        ...
        <div class="allCond">
            <form action="<?php echo U("Admin/Job/add");?>" method="POST">
                <div class="form_con" style="display: block;">
                    <p class="form_Itext">
                        <label>岗位名称：</label>
                        <input type="text" class="i3" name="name" value=""/>
                    </p>

                    <p class="form_Itext">
                        <label>招聘人数：</label>
                        <input type="text" class="i3" name="quantity"/>
                    </p>
                    <p class="form_textarea">
                        <label>岗位职责：</label>
                        <textarea placeholder="岗位职责" name="duties"></textarea>
                    </p>
                    <p class="form_textarea">
                        <label>任职要求：</label>
                        <textarea placeholder="任职要求" name="demand"></textarea>
                    </p>
                    <p class="form_Itext">
                        <label>工作地点：</label>
                        <input type="text" class="i3" name="address"/>
                    </p>
