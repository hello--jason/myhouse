<?php include TMPL_PATH . 'Admin/header.php' ?>
    <div class="conter clearfix">
        ...
        <div class="contRight">
            ...
            <div class="allCond">
                <form action="<?php echo U("Admin/Advert/add");?>" method="POST">
                    <div class="form_con" style="display: block;">
                        ...
                        <p class="form_Itext">
                            <label>关键词：</label>
                            <input type="text" class="i3" name="keyword" />
                        </p>
                        <p class="form_Itext">
                            <label>url：</label>
                            <input type="text" class="i3" name="website" />
                        </p>
                        <p class="form_Itext">
                            <label>电脑端图片：</label>
                            <img src="/Public/Static/Admin/images/upload_img_back.png" class="js_upload_image" id="js_image1" width="200" height="200"/>
                            <input type="hidden" name="image" class="i3" />
                            <font color="blue">图片已经存在，修改则重新上传</font>  图片尺寸170×250
                        </p>
                        <p class="form_Itext">
                            <label>手机端图片：</label>
                            <img src="/Public/Static/Admin/images/upload_img_back.png" class="js_upload_image" id="js_image2" width="200" height="200"/>
