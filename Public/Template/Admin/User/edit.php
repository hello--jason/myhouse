...
<div class="conter clearfix">
    ...
    <div class="contRight">
        ...
        <div class="allCond">
            <form action="<?php echo U("Admin/User/edit", array("id"=>$user['id']));?>" method="POST">
                <div class="form_con" style="display: block;">
                    <p class="form_Itext">
                        <label>头像：</label>
                        <img src="<?php echo $user['image'] ? $user['image'] : '/Public/Static/Admin/images/upload_img_back.png';?>" class="js_upload_image" width="150" height="150">
                        <input type="hidden" class="i3 js_image_val" name="image" value="<?php echo $user['image'];?>"/>
                    </p>

                    <p class="form_Itext">
                        <label>用户名：</label>
                        <input type="text" class="i3" name="nickname" value="<?php echo $user['nickname']?>"/>
                    </p>
                    <p class="form_Itext">
                        <label>性别：</label>
                        <select name="sex">
                    ...
                    <p class="form_Itext">
                        <label>手机号：</label>
                        <input type="text" class="i3" name="mobile" value="<?php echo $user['mobile']?>"/>
                    </p>
                    <p class="form_Itext">
                        <label>Email：</label>
                        <input type="text" class="i3" name="email" value="<?php echo $user['email']?>"/>
                    </p>
                    <p class="bnt_Con">
